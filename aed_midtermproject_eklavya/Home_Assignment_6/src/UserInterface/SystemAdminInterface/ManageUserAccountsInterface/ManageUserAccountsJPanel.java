...
public class ManageUserAccountsJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageUserAccountsJPanel(JPanel userProcessContainer, PersonDirectory personDirectory, 
    ...
    public void populateTable(){
        ...
        for(UserAccount userAccount : userAccountDirectory.getUserList()){
            ...
            if(userAccount.getPerson()!=null){
                row[3] = userAccount.getPerson().getPersonID();
                row[4] = userAccount.getPerson().getFirstName();
            }
            else{
                row[3] = userAccount.getSupplier().getSupplierID();
                row[4] = userAccount.getSupplier().getSupplierName();
            }
            row[0] = userAccount;
    ...
    private void initComponents() {
        ...
        tblUserAccountList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "User Name", "Password", "Object ID", "Object", "Role", "Status"
            }
        ) {
    ...
    private void btnSearchUserAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchUserAccountActionPerformed
        ...
        if(txtSearchUserID.getText().equals("") || !(txtSearchUserID.getText().matches("[0-9A-Z]+"))){
            JOptionPane.showMessageDialog(null,"Invalid Data");
        }
        else{
            UserAccount result = userAccountDirectory.searchUserAccount(txtSearchUserID.getText());
            if(result == null){
    ...
    private void btnDeleteUserAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteUserAccountActionPerformed
        ...
        if(selectedRow >= 0){
            UserAccount userAccount = (UserAccount)tblUserAccountList.getValueAt(selectedRow, 0);
    ...
    private void btnAddUserAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddUserAccountActionPerformed
        // TODO add your handling code here:
        AddUserAccountJPanel panel = new AddUserAccountJPanel(userProcessContainer, personDirectory, userAccountDirectory, supplierDirectory);
        userProcessContainer.add("SearchUpdateUserAccountJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
