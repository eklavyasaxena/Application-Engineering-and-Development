...
import UserInterface.InventoryClerkWorkArea.ProcessWorkRequestJPanel;
...
public class PharmacistWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : labOrganization.getWorkQueue().getWorkRequestList()){
            ...
            row[3] = request.getWorkRequestReceiver() == null ? null : request.getWorkRequestReceiver().getEmployee().getEmployeeName();
            if(business.getEnterprise(request.getWorkRequestReceiver())!=enterprise && request.getWorkRequestReceiver()!=null){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Vaccine Request from Enterprise");
        ...
        jLabel3.setText("Vaccine Request from Network");
        ...
        lblWelcome.setText("Pharmacist Work Area");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(383, 399, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
