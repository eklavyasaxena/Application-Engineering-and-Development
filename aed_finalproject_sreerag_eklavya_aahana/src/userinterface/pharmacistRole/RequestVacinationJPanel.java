...
public class RequestVacinationJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Vaccine Name", "Quantity", "Receiver", "Status"
            }
        ) {
        ...
        requestTestJButton1.setBackground(new java.awt.Color(137, 255, 137));
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        Network net = business.getNetwork(business.getCurrentUser());
        net.getWorkQueue().getWorkRequestList().add(request);
